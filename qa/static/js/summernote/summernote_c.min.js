...
function(a) {
    ...
    Array.prototype.map || (Array.prototype.map = function(a, b) {
        ...
        for (arguments.length > 1 && (c = b), d = new Array(g), e = 0; g > e;) {
            var h, i;
            e in f && (h = f[e], i = a.call(c, h, e, f), d[e] = i),
            e++
        }
        return d
    });
    ...
    n = function() {
        ...
        e = function(b) {
            ...
            var e;
            return e = c.is(".note-editor, .note-air-editor") ? c: a("#note-editor-" + k.last(c.attr("id").split("-"))),
            d(e)
        },
        f = function(a) {
    ...
    o = function() {
        var b = function(a, b) {
            ...
            if (0 !== c && n.isText(g[c - 1])) {
                ...
                for (var l = j.text.replace(/[\r\n]/g, "").length; l > i.nodeValue.length && i.nextSibling;) l -= i.nodeValue.length,
                i = i.nextSibling;
                i.nodeValue;
                b && i.nextSibling && n.isText(i.nextSibling) && l === i.nodeValue.length && (l -= i.nodeValue.length, i = i.nextSibling),
                e = i,
                c = l
            }
            return {
        ...
        d = function(b, e, f, g) {
            ...
            this.nodes = function(a, b) {
                ...
                g = [],
                h = [];
                return n.walkPoint(e, f,
                function(b) {
                    if (!n.isEditable(b.node)) {
                        var e;
                        d ? (n.isLeftEdgePoint(b) && h.push(b.node), n.isRightEdgePoint(b) && k.contains(h, b.node) && (e = b.node)) : e = c ? n.ancestor(b.node, a) : b.node,
                        e && a(e) && g.push(e)
                    }
                },
                !0),
            ...
            this.splitText = function() {
                var a = b === f,
                c = this.getPoints();
                return n.isText(f) && !n.isEdgePoint(this.getEndPoint()) && f.splitText(g),
            ...
            this.deleteContents = function() {
                ...
                e = n.prevPointUntil(b.getStartPoint(),
                function(a) {
            ...
            this.wrapBodyInlineWithPara = function() {
                if (n.isBodyContainer(b) && n.isEmpty(b)) return b.innerHTML = n.emptyPara,
                ...
                if (n.isInline(a.sc)) {
                    ...
                    c = k.last(e),
                    n.isInline(c) || (c = e[e.length - 2] || a.sc.childNodes[a.so])
            ...
            this.getWordRange = function(a) {
                ...
                var c = n.prevPointUntil(b,
                function(a) {
                    return ! n.isCharPoint(a)
                });
                return a && (b = n.nextPointUntil(b,
                function(a) {
                    return ! n.isCharPoint(a)
                })),
        ...
        return {
            ...
            createFromNode: function(a) {
                ...
                d = a,
                e = n.nodeLength(d);
                return n.isVoid(b) && (c = n.listPrev(b).length - 1, b = b.parentNode),
    ...
    p = {
        ...
        options: {
            ...
            onCreateLink: function(a) {
                return - 1 !== a.indexOf("@") && -1 === a.indexOf(":") && (a = "mailto:" + a),
                a
            },
            keyMap: {
                pc: {
    ...
    t = function() {
        ...
        this.styleNodes = function(b, c) {
            ...
            if (e) {
                ...
                return h.map(function(b) {
                    ...
                    return a.each(e,
                    function(a, b) {
                        n.appendChildNodes(d, b.childNodes),
                        n.remove(b)
                    }),
                    k.head(c)
                })
        ...
        this.current = function(b) {
            ...
            return d.anchor = b.isOnAnchor() && n.ancestor(b.sc, n.isAnchor),
    ...
    u = function() {
        ...
        this.indent = function() {
            ...
            function(c, d) {
                var e = k.head(d);
                n.isLi(e) ? b.wrapList(d, e.parentNode.nodeName) : a.each(d,
                function(b, c) {
                    a(c).css("marginLeft",
                    function(a, b) {
        ...
        this.outdent = function() {
            ...
            function(c, d) {
                var e = k.head(d);
                n.isLi(e) ? b.releaseList([d]) : a.each(d,
                function(b, c) {
                    a(c).css("marginLeft",
                    function(a, b) {
        ...
        this.releaseList = function(b, c) {
            ...
            function(b, e) {
                ...
                (c || !n.isList(h.parentNode)) && (e = e.map(function(a) {
                    return n.replace(a, "P")
                })),
                a.each(k.from(e).reverse(),
                function(a, b) {
                    n.insertAfter(b, h)
                });
    ...
    y = function(b) {
        ...
        this.insertText = function(a, b) {
            ...
            o.create(c, n.nodeLength(c)).select(),
            m(a)
        },
        this.pasteHTML = function(a, b) {
            l(a);
            var c = o.create().pasteHTML(b);
            o.createFromNodeAfter(k.last(c)).select(),
            m(a)
        },
        ...
        this.removeBogus = function(a) {
            ...
            if (b) {
                ...
                d = c.nodeValue.indexOf(n.ZERO_WIDTH_NBSP_CHAR); - 1 !== d && c.deleteData(d, 1),
        ...
        this.createLink = function(b, c, e) {
            ...
            u = t.getEndPoint();
            o.create(s.node, s.offset, u.node, u.offset).select(),
            m(b)
        },
        ...
        this.insertTable = function(a, b) {
            ...
            d.insertNode(e.createTable(c[0], c[1])),
            m(a)
        },
        ...
        this.focus = function(a) {
            a.focus(),
            i.isFF && !o.create().isOnEditable() && o.createFromNode(a[0]).normalize().collapse().select()
        },
    ...
    z = function() {
        this.update = function(b, c) {
            ...
            if (c.image) {
                var f = a(c.image);
                e('button[data-event="imageShape"][data-value="img-rounded"]',
                function() {
                    return f.hasClass("img-rounded")
                }),
                e('button[data-event="imageShape"][data-value="img-circle"]',
                function() {
                    return f.hasClass("img-circle")
                }),
                e('button[data-event="imageShape"][data-value="img-thumbnail"]',
                function() {
                    return f.hasClass("img-thumbnail")
                }),
                e('button[data-event="imageShape"]:not([data-value])',
                function() {
                    return ! f.is(".img-rounded, .img-circle, .img-thumbnail")
                });
                var g = f.css("float");
                e('button[data-event="floatMe"][data-value="left"]',
                function() {
                    return "left" === g
                }),
                e('button[data-event="floatMe"][data-value="right"]',
                function() {
                    return "right" === g
                }),
                e('button[data-event="floatMe"][data-value="none"]',
                function() {
                    return "left" !== g && "right" !== g
                });
                var h = f.attr("style");
                return e('button[data-event="resize"][data-value="1"]',
                function() {
                    return !! /(^|\s)(max-)?width\s*:\s*100%/.test(h)
                }),
                e('button[data-event="resize"][data-value="0.5"]',
                function() {
                    return !! /(^|\s)(max-)?width\s*:\s*50%/.test(h)
                }),
                void e('button[data-event="resize"][data-value="0.25"]',
                function() {
    ...
    F = function(b) {
        ...
        this.toggle = function(a) {
            ...
            j ? (g.data("orgheight", g.css("height")), c.on("resize",
            function() {
                i({
    ...
    i.hasCodeMirror && (i.isSupportAmd ? require(["CodeMirror"],
    function(a) {
        h = a
    }) : h = window.CodeMirror);
    var G = function(a) {
    ...
    H = function(b) {
        var c = a(document);
        this.attach = function(a, b) {
            b.airMode || b.disableDragAndDrop ? c.on("drop",
            function(a) {
                a.preventDefault()
        ...
        this.attachDragAndDropEvent = function(d, e) {
            ...
            function(c) {
                ...
                if (d && d.files && d.files.length) c.preventDefault(),
                e.editable().focus(),
                b.insertImages(e, d.files);
                else for (var f = function() {
    ...
    I = function(b) {
        ...
        var d = function(d) {
            ...
            if (n.isImg(f)) {
                for (var g = f.src,
                h = atob(g.split(",")[1]), i = new Uint8Array(h.length), j = 0; j < h.length; j++) i[j] = h.charCodeAt(j);
                var k = new Blob([i], {
                    type: "image/png"
                });
        ...
        e = function(a) {
            ...
            if (c && c.items && c.items.length) {
                ...
                "file" === f.kind && -1 !== f.type.indexOf("image/") && b.insertImages(d, [f.getAsFile()]),
    ...
    M = function() {
        ...
        this.insertImages = function(b, e) {
            ...
            i = g.data("callbacks"),
            j = f.data("options");
            i.onImageUpload ? d(h, i, "image.upload")(e) : a.each(e,
            function(a, b) {
                var e = b.name;
        ...
        l = function(a) {
            var b = n.makeLayoutInfo(a.currentTarget || a.target);
            c.popover.hide(b.popover()),
            c.handle.hide(b.handle())
        },
        m = function(b) {
        ...
        this.attachCustomEvent = function(b, c) {
            ...
            n.isTextarea(k.head(e)) && e.closest("form").submit(function(a) {
                b.holder().val(b.holder().code()),
                d(e, g, "submit").call(this, a, e.code())
            }),
            n.isTextarea(k.head(e)) && c.textareaAutoSync && e.on("summernote.change",
            function() {
                b.holder().val(b.holder().code())
            }),
            d(e, g, "init")(b);
    ...
    N = function() {
        ...
        t = function(a, b) {
            ...
            return b.extraKeys && d.push("<div " + c + ">" + s(a, b) + "</div>"),
        ...
        v = {
            image: function(a, b) {
                ...
                var g = '<div id="container" class="form-group row note-group-select-from-files" style="position: relative;"><label>' + a.image.selectFromFiles + '</label><a class="btn btn-default btn-lg " id="pickfiles" href="#" style="position: relative; z-index: 1;"> <i class="glyphicon glyphicon-plus"></i> <sapn>选择文件</sapn> </a>' + c + '</div><div class="form-group row"><label>' + a.image.url + '</label><input class="note-image-url form-control col-md-12" type="text" /></div>',
            ...
            help: function(a, b) {
                var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (i.isMac ? t(a, b) : u(t(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.15</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
        ...
        y = function(a) {
            return i.isMac && (a = a.replace("CMD", "⌘").replace("SHIFT", "⇧")),
        ...
        this.createLayoutByFrame = function(b, c) {
            ...
            c.height > 0 && a('<div class="note-statusbar">' + (c.disableResizeEditor ? "": x()) + "</div>").prependTo(e);
    ...
    a.summernote.addPlugin = function(b) {
        ...
        b.buttons && a.each(b.buttons,
        function(a, b) {
            O.addButtonInfo(a, b)
        }),
        b.dialogs && a.each(b.dialogs,
        function(a, b) {
            O.addDialogInfo(a, b)
        }),
        b.events && a.each(b.events,
        function(b, c) {
            a.summernote.pluginEvents[b] = c
        }),
        b.langs && a.each(b.langs,
        function(b, c) {
    ...
    a.fn.extend({
        summernote: function() {
            ...
            if (e = a.extend({},
            a.summernote.options, e), e.icons = a.extend({},
            a.summernote.options.icons, e.icons), e.langInfo = a.extend(!0, {},
            a.summernote.lang["en-US"], a.summernote.lang[e.lang]), !c && d) for (var f = 0,
        ...
        code: function(b) {
            if (void 0 === b) {
                ...
                if (e && e.length) {
                    ...
                    return P.invoke("codeview.sync", d),
